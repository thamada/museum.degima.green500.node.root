...
__all__ = ['global_keys', 'section_keys', 'all_keys_expander_dict', 'synonym_dict', 'inverted_synonym_dict', 'nomask_default_list', 'get_default']
...
for isynkey in inverted_synonym_dict.keys ():
    isynvalue = inverted_synonym_dict[isynkey]
...
for key in global_keys.keys () + section_keys.keys ():
    all_keys_expander_dict [key.replace (" ", "").replace ("\t", "").lower ()] = key
