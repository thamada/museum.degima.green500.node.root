...
tie %Config, 'Config', {
    archlibexp => '/usr/lib64/perl5/5.10.0/x86_64-linux-thread-multi',
    ...
    osname => 'linux',
    osvers => '2.6.32-72.el6.bz634452.x86_64',
    path_sep => ':',
    privlibexp => '/usr/lib/perl5/5.10.0',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib64/perl5/site_perl/5.10.0/x86_64-linux-thread-multi',
