...
unless(defined(&_FEATURES_H)) {
 ...
 elsif(defined (defined(&_XOPEN_SOURCE) ? &_XOPEN_SOURCE : undef)  && ((defined(&_XOPEN_SOURCE) ? &_XOPEN_SOURCE : undef) - 0) < 700) {
    ...
    if(defined (defined(&_FORTIFY_SOURCE) ? &_FORTIFY_SOURCE : undef)  && (defined(&_FORTIFY_SOURCE) ? &_FORTIFY_SOURCE : undef) > 0 && defined (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef)  && (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef) > 0) {
