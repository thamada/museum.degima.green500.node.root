...
"x86_64-linux-thread-multi-2.6.32-72.el6.bz634452.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.32-72.el6.bz634452.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
