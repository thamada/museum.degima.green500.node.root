...
TK_LIBS='-lX11 -lXft -lXrender -lfontconfig -lfreetype -lX11    -ldl  -lieee -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/lib64 -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/lib64 -ltk8.5'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/lib64 -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/lib64/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/lib64/libtkstub8.5.a'
