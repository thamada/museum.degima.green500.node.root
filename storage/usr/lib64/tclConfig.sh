...
TCL_EXTRA_CFLAGS='-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic -pipe '

# Base command to use for combining object files into a shared library:
TCL_SHLIB_LD='${CC} -shared ${CFLAGS} ${LDFLAGS} -fPIC -Wl,-soname,${@}'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib64 -ltcl8.5'
...
TCL_PACKAGE_PATH='/usr/lib64/tcl8.5 /usr/share/tcl8.5 /usr/lib64/tk8.5 /usr/share/tk8.5 '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib64 -ltclstub8.5'
