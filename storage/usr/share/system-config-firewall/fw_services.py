...
#             "useful."),
    ...
    _Service("nfs", _("NFS4"), [ ("2049", "tcp"), ("2049", "udp"), ],
    ...
    _Service("imaps", _("IMAP over SSL"), [ ("993", "tcp"), ],
             _("The Internet Message Access Protocol over SSL (IMAPs) allows "
               "a local client to access e-mail on a remote server in a secure "
    ...
    _Service("cluster-suite", _("Red Hat Cluster Suite"), [
            ...
            (21064, "tcp"),
            # cssd
            (50006, "tcp"), (50008, "tcp"), (50009, "tcp"),
            (50007, "udp"),
            ],
             _("This option allows you to use the Red Hat Cluster Suite. "
               "Ports are opened for openais, rgnamanager, ricci, dlm and "
               "cssd. You need the Red Hat Cluster Suite for this option to "
               "be useful.")),
    ]
