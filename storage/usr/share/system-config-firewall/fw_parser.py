...
def _addStandardOptions(parser):
    ...
    parser.add_option("--block-icmp",
                      ...
                      callback=_append_unique,
                      metavar=_("<icmp type>"),
                      help=_("Block this ICMP type. The default is to accecpt "
                             "all ICMP types."))
