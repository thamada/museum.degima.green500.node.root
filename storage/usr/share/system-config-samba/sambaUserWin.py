...
# -*- coding: utf-8 -*-
#
# Copyright © 2002 - 2007, 2009 Red Hat, Inc.
...
class SambaUserWin(object):

    def __init__(self, parent, xml, samba_backend, main_window):
        ...
        self.add_user_win = addUserWin.AddUserWin(self, self.samba_backend, xml)
    ...
    def fillUserList(self):
        list = self.samba_backend.getPasswdFile()
    ...
    def onUsersOkButtonClicked(self, *args):
        ...
        if not section:
            raise Exception ("No [global] section found.")
    ...
    def onEditUserButtonClicked(self, *args):
        ...
        user_dict = self.samba_backend.getUserDict()
        ...
        if unix_name in user_keys:
            ...
            windows_name = line.split ("=", 1)[1].strip ()
    ...
    def onDeleteUserButtonClicked(self, *args):
        ...
        self.samba_backend.deleteUser (name)
