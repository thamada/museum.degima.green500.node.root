...
class plugin(Plugin):
    ...
    def __init__(self):
        ...
        self.set_priority(56)

    def analyze(self, avc):
        if avc.matches_source_types(['smbd_t'])                             and \
           not avc.matches_target_types(['shadow_t','public_content_rw_t']) and \
           avc.has_any_access_in(['write']):
            # MATCH
            avc.set_template_substitutions(BOOLEAN="samba_export_all_rw")
