...
namespace DBus {
  ...
  public:
    ...
    {
      DBUS_CXX_DEBUG("Method<void>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1,T_arg2>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1,T_arg2,T_arg3>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1,T_arg2,T_arg3,T_arg4>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5>::handle_call_message   method=" << m_name );
  ...
  public:
    ...
    virtual HandlerResult handle_call_message( DBusCxxPointer<Connection> connection, CallMessage::const_pointer message )
    {
      DBUS_CXX_DEBUG("Method<void, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5,T_arg6>::handle_call_message   method=" << m_name );
