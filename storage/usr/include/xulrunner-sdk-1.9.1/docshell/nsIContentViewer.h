...
/* starting interface:    nsIContentViewer_MOZILLA_1_9_1_BRANCH */
#define NS_ICONTENTVIEWER_MOZILLA_1_9_1_BRANCH_IID_STR "35f0bcf6-e5cb-4b41-bceb-810247b919ac"

#define NS_ICONTENTVIEWER_MOZILLA_1_9_1_BRANCH_IID \
  {0x35f0bcf6, 0xe5cb, 0x4b41, \
    { 0xbc, 0xeb, 0x81, 0x02, 0x47, 0xb9, 0x19, 0xac }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewer_MOZILLA_1_9_1_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ICONTENTVIEWER_MOZILLA_1_9_1_BRANCH_IID)
   ...
   *        ignored.
   */
  /* boolean permitUnloadAndCloseWindow (); */
  NS_SCRIPTABLE NS_IMETHOD PermitUnloadAndCloseWindow(PRBool *_retval NS_OUTPARAM) = 0;
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIContentViewer_MOZILLA_1_9_1_BRANCH, NS_ICONTENTVIEWER_MOZILLA_1_9_1_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSICONTENTVIEWER_MOZILLA_1_9_1_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD PermitUnloadAndCloseWindow(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ResetCloseWindow(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTENTVIEWER_MOZILLA_1_9_1_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD PermitUnloadAndCloseWindow(PRBool *_retval NS_OUTPARAM) { return _to PermitUnloadAndCloseWindow(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ResetCloseWindow(void) { return _to ResetCloseWindow(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTENTVIEWER_MOZILLA_1_9_1_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD PermitUnloadAndCloseWindow(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->PermitUnloadAndCloseWindow(_retval); } \
...
/* Header file */
class nsContentViewer_MOZILLA_1_9_1_BRANCH : public nsIContentViewer_MOZILLA_1_9_1_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSICONTENTVIEWER_MOZILLA_1_9_1_BRANCH

  nsContentViewer_MOZILLA_1_9_1_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsContentViewer_MOZILLA_1_9_1_BRANCH, nsIContentViewer_MOZILLA_1_9_1_BRANCH)

nsContentViewer_MOZILLA_1_9_1_BRANCH::nsContentViewer_MOZILLA_1_9_1_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* boolean permitUnloadAndCloseWindow (); */
NS_IMETHODIMP nsContentViewer_MOZILLA_1_9_1_BRANCH::PermitUnloadAndCloseWindow(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void resetCloseWindow (); */
NS_IMETHODIMP nsContentViewer_MOZILLA_1_9_1_BRANCH::ResetCloseWindow()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
